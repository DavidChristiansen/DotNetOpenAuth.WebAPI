...
namespace DotNetOpenAuth.WebAPI.HostSample.Infrastructure.OAuth
{
    ...
    partial void OnOpenIDFriendlyIdentifierChanged();
		...
		[Association(Name="User_ClientAuthorization", Storage="_OAuthTokens", ThisKey="UserId", OtherKey="UserId")]
    ...
    partial void OnClientTypeChanged();
		...
		[Column(Storage="_ClientIdentifier", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ClientSecret", DbType="NVarChar(50)")]
		...
		[Association(Name="Client_ClientAuthorization", Storage="_OAuthTokens", ThisKey="ClientId", OtherKey="ClientId")]
		public EntitySet<ClientAuthorization> ClientAuthorizations
		{
			get
			{
	...
	[Table(Name="dbo.ClientAuthorization")]
    ...
    partial void OnExpirationDateUtcChanged();
		...
		[Column(Storage="_ExpirationDateUtc", DbType="DateTime NULL")]
		...
		[Association(Name="Client_ClientAuthorization", Storage="_Client", ThisKey="ClientId", OtherKey="ClientId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[Association(Name="User_ClientAuthorization", Storage="_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true, DeleteRule="CASCADE")]
		public User User
		{
			get
			{
    ...
    partial void OnTimestampChanged();
		...
		[Column(Storage="_Context", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_Code", CanBeNull=false, IsPrimaryKey=true)]
		public string Code
		{
			get
			{
		...
		[Column(Storage="_Timestamp", IsPrimaryKey=true)]
    ...
    partial void OnSecretChanged();
		...
		[Column(Storage="_Bucket", CanBeNull=false, IsPrimaryKey=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Handle", CanBeNull=false, IsPrimaryKey=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ExpiresUtc", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_Secret", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public byte[] Secret
		{
			get
			{
